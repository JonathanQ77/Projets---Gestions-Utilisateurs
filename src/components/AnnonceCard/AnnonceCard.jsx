      ...
      >
        ...
        <div className="p-4 text-center">
          <div className="flex justify-between mb-5 mt-5">
            <h2 className="text-2xl sm:font-raleway  relative left-[60px] mb-6 mt-5 ml-20 sm:left-44 md:-left-5 lg:-left-[15px] xl:left-[50px] 2xl:left-[150px] font-roboto font-semibold">
              {title}
            </h2>
            <svg
